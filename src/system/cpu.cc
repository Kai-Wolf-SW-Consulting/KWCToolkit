...
const std::string& CPU::cpu_brand() const {
    return cpu_brand_;
}
...
int CPU::extended_model() const {
    return ext_model_;
}

int CPU::extended_family() const {
    return ext_family_;
}

bool CPU::has_mmx() const {
    return has_mmx_;
}

bool CPU::has_sse() const {
    return has_sse_;
}

bool CPU::has_sse2() const {
    return has_sse2_;
}

bool CPU::has_sse3() const {
    return has_sse3_;
}

bool CPU::has_sse41() const {
    return has_sse41_;
}

bool CPU::has_sse42() const {
    return has_sse42_;
}

bool CPU::has_avx() const {
    return has_avx_;
}

bool CPU::has_avx2() const {
    return has_avx2_;
}
